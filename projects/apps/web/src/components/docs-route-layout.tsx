        ...
        <DocsLayoutContainer
            ...
            style={{
                ...
                backgroundImage: [
                    ...
                    'radial-gradient(ellipse at 48% -12%, rgba(56, 189, 248, 0.28), transparent 43%)',
                    'radial-gradient(ellipse at 82% 8%, rgba(217, 70, 239, 0.24), transparent 38%)',
                    'radial-gradient(ellipse at 30% 22%, rgba(79, 70, 229, 0.24), transparent 44%)',
                    'radial-gradient(ellipse at 68% 62%, rgba(236, 72, 153, 0.16), transparent 44%)',
                    'linear-gradient(180deg, rgba(0, 0, 0, 0.24), rgba(0, 0, 0, 0.38) 48%, rgba(0, 0, 0, 0.58) 100%)',
