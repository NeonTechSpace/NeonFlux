...
export function DashboardBlueprintDriftPanel({
    drift,
    settings,
    busyAction,
    onCheckLatest,
    ...
    onCheckLatest: () => void;
    onCreateBackup: () => void;
    onCreateDryRun: (backup: DashboardBlueprintBackupSummary) => void;
...
function ScheduledDriftStatus({
    ...
    busy: boolean;
    isReviewing: boolean;
    scheduledDrift: NonNullable<DashboardBlueprintBackupSettings['scheduledDrift']>;
    onReviewScheduledDrift: (baselineBackupId: string) => void;
}) {
...
function readScheduledDriftCopy(scheduledDrift: NonNullable<DashboardBlueprintBackupSettings['scheduledDrift']>): {
    detail: string;
    title: string;
