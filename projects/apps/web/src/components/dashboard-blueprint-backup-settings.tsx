...
import type { DashboardBlueprintBackupSettings as DashboardBlueprintBackupSettingsRecord } from '../server/dashboard-blueprint-model.js';
...
export type DashboardBlueprintBackupSettingsValue = typeof backupSettingsSchema.infer;

export function DashboardBlueprintBackupSettings({
    settings,
    enabled,
    cadenceWeeks,
    retentionDays,
    ...
    settings: DashboardBlueprintBackupSettingsRecord;
    enabled: boolean;
    cadenceWeeks: number;
    ...
    onSave: (value: DashboardBlueprintBackupSettingsValue) => void;
}) {
    const form = useForm({
        defaultValues: {
            enabled,
