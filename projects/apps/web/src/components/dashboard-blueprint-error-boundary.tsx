...
class DashboardBlueprintRenderBoundary extends Component<BoundaryProps, BoundaryState> {
...
export function DashboardBlueprintErrorBoundary({ children, onRetry }: BoundaryProps) {
    const [attempt, setAttempt] = useState(0);

    return (
        <DashboardBlueprintRenderBoundary
            key={attempt}
            onRetry={() => {
...
export function DashboardBlueprintErrorState({
    title,
    message,
    diagnosticCode,
    onRetry,
