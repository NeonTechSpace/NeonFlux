...
const dashboardGuildCardBaseClassName =
    'group relative isolate flex min-h-[7.5rem] items-center overflow-hidden rounded-[var(--dash-radius-panel)] border border-[rgba(112,177,224,0.3)] bg-[radial-gradient(circle_at_8%_0%,rgba(90,215,255,0.1),transparent_42%),linear-gradient(145deg,rgba(11,24,43,0.94),rgba(15,15,35,0.92))] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.075),var(--dash-shadow-surface),0_18px_52px_rgba(3,7,18,0.2)] backdrop-blur-[18px] backdrop-saturate-[1.28] transition-[border-color,box-shadow] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] sm:p-5';
const dashboardGuildCardDecorationClassName =
    "before:pointer-events-none before:absolute before:inset-0 before:z-0 before:bg-[radial-gradient(circle_at_12%_10%,rgba(90,215,255,0.24),transparent_46%),radial-gradient(circle_at_92%_110%,rgba(157,140,255,0.22),transparent_52%)] before:opacity-0 before:transition-opacity before:duration-300 before:ease-[cubic-bezier(0.22,1,0.36,1)] before:content-[''] after:pointer-events-none after:absolute after:inset-x-[12%] after:bottom-0 after:h-px after:origin-center after:scale-x-[0.28] after:bg-[linear-gradient(90deg,transparent,var(--dash-primary),var(--dash-creative),transparent)] after:opacity-30 after:transition-[opacity,transform] after:duration-300 after:ease-[cubic-bezier(0.22,1,0.36,1)] after:content-['']";
const dashboardGuildCardInteractionClassName =
    'hover:border-[rgba(90,215,255,0.68)] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.11),0_0_0_1px_rgba(90,215,255,0.1),0_18px_42px_rgba(4,10,24,0.4),0_0_30px_rgba(90,215,255,0.13)] hover:before:opacity-100 hover:after:scale-x-100 hover:after:opacity-[0.86] focus-visible:border-[rgba(90,215,255,0.68)] focus-visible:shadow-[var(--dash-shadow-focus),0_18px_42px_rgba(4,10,24,0.4),0_0_30px_rgba(90,215,255,0.13)] focus-visible:outline-none focus-visible:before:opacity-100 focus-visible:after:scale-x-100 focus-visible:after:opacity-[0.86]';
        ...
        <li>
            <Link
                ...
                <div className='relative flex min-w-0 flex-1 items-center gap-4'>
                    <span className='grid size-14 shrink-0 place-items-center overflow-hidden rounded-full border border-[var(--dash-border-interactive)] bg-[var(--dash-surface-raised)] shadow-[0_0_22px_rgba(90,215,255,0.14)] transition-[border-color,box-shadow] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:border-[var(--dash-primary)] group-hover:shadow-[0_0_28px_rgba(90,215,255,0.3)] motion-reduce:transition-none [.dashboard-theme[data-reduce-effects=true]_&]:transition-none'>
                    ...
                    <span className='grid size-9 shrink-0 place-items-center rounded-[var(--dash-radius-control)] border border-[var(--dash-border)] bg-[var(--dash-primary-soft)] text-[var(--dash-primary)] transition-[border-color,box-shadow] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:border-[var(--dash-primary)] group-hover:shadow-[0_0_16px_rgba(90,215,255,0.2)] motion-reduce:transition-none [.dashboard-theme[data-reduce-effects=true]_&]:transition-none'>
