...
import type { DashboardBlueprintExplorerJsonDiff } from './dashboard-blueprint-explorer-diff.js';

export function DashboardBlueprintExplorerJsonDiffView({
    comparisonTarget,
    jsonDiff,
    source,
}: {
    comparisonTarget: DashboardBlueprintExplorerComparisonTarget;
    jsonDiff: DashboardBlueprintExplorerJsonDiff | undefined;
