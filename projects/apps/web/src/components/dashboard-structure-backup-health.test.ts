...
describe('deriveDashboardStructureBackupHealth', () => {
    ...
    it('reports the latest backup failure and prefers settings error copy', () => {
        const issues = deriveDashboardStructureBackupHealth({
    ...
    it('warns only after the scheduled backup grace window has elapsed', () => {
        const recent = deriveDashboardStructureBackupHealth({
            backups: [],
            formatDate,
            nowMs,
            settings: createSettings({
        ...
        const overdue = deriveDashboardStructureBackupHealth({
            backups: [],
            formatDate,
            nowMs,
            settings: createSettings({
...
function createSettings(overrides: Partial<DashboardStructureBackupSettings> = {}): DashboardStructureBackupSettings {
    return {
        cadenceWeeks: 1,
        enabled: false,
        retentionDays: 180,
...
function createBackup(overrides: Partial<DashboardStructureBackupSummary> = {}): DashboardStructureBackupSummary {
    return {
        categoryCount: 1,
        channelCount: 1,
