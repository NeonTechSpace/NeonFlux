export type DashboardBlueprintSurface = 'current' | 'backups' | 'compare' | 'deploy' | 'runs';

export const dashboardBlueprintSurfaceIdentity: Record<
    DashboardBlueprintSurface,
