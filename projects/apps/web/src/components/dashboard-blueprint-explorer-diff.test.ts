...
import {
    ...
    formatDashboardBlueprintExplorerSnapshotJson,
} from './dashboard-blueprint-explorer-diff.js';
import type { DashboardBlueprintExplorerSnapshot } from './dashboard-blueprint-explorer-model.js';

describe('buildDashboardBlueprintExplorerJsonDiff', () => {
    it('builds a file diff for changed server blueprint JSON', () => {
        const before = formatDashboardBlueprintExplorerSnapshotJson(createSnapshot());
        const after = formatDashboardBlueprintExplorerSnapshotJson(
            createSnapshot({
                channels: [
                    {
        ...
        const result = buildDashboardBlueprintExplorerJsonDiff({
            after,
...
function createSnapshot(
    overrides: Partial<DashboardBlueprintExplorerSnapshot> = {}
