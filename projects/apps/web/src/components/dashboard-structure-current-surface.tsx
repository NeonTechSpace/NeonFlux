...
import type { DashboardStructureBackupSettings } from '../server/dashboard-structure-model.js';
...
import type { BackupPageState, DriftState } from './dashboard-structure-panel-types.js';
...
export type DashboardStructureCurrentWorkspace = {
...
export function DashboardStructureCurrentSurface({ workspace }: { workspace: DashboardStructureCurrentWorkspace }) {
