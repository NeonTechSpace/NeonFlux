...
import {
    createVcGeneratorControlRequest as createVcGeneratorControlRequestPostgres,
    expirePendingVcGeneratorControlRequests as expirePendingVcGeneratorControlRequestsPostgres,
    findActiveGeneratedVoiceChannelByOwner as findActiveGeneratedVoiceChannelByOwnerPostgres,
    findPendingVcGeneratorControlRequest as findPendingVcGeneratorControlRequestPostgres,
    updateVcGeneratorControlRequest as updateVcGeneratorControlRequestPostgres,
    type GeneratedVoiceChannelControlRecord,
    type GuildFeatureRepositoryError,
    type VcGeneratorControlAction,
    type VcGeneratorControlRequestError,
    type VcGeneratorControlRequestRecord,
    type VcGeneratorControlRequestStatus,
} from '@neonflux/db';
...
type PostgresVcGeneratorControlRequestDb = Parameters<typeof createVcGeneratorControlRequestPostgres>[0];
type VcGeneratorControlRequestDb = ConvexPersistenceDatabase | PostgresVcGeneratorControlRequestDb;
...
export async function findActiveGeneratedVoiceChannelByOwner(
    ...
    if (!isConvexPersistenceDatabase(db)) return findActiveGeneratedVoiceChannelByOwnerPostgres(db, input);
...
export async function createVcGeneratorControlRequest(
    ...
    if (!isConvexPersistenceDatabase(db)) return createVcGeneratorControlRequestPostgres(db, input);
...
export async function findPendingVcGeneratorControlRequest(
    ...
    if (!isConvexPersistenceDatabase(db)) return findPendingVcGeneratorControlRequestPostgres(db, input);
...
export async function updateVcGeneratorControlRequest(
    ...
    if (!isConvexPersistenceDatabase(db)) return updateVcGeneratorControlRequestPostgres(db, input);
...
export async function expirePendingVcGeneratorControlRequests(
    ...
    if (!isConvexPersistenceDatabase(db)) return expirePendingVcGeneratorControlRequestsPostgres(db, input);
