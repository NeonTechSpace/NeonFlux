...
import {
    deleteReactionRoleMessage as deleteReactionRoleMessagePostgres,
    deleteReactionRoleOption as deleteReactionRoleOptionPostgres,
    deleteReactionRoleOptionByMessage as deleteReactionRoleOptionByMessagePostgres,
    findEnabledReactionRoleOptionByReaction as findEnabledReactionRoleOptionByReactionPostgres,
    findReactionRoleMessage as findReactionRoleMessagePostgres,
    findReactionRoleOption as findReactionRoleOptionPostgres,
    listActiveReactionRoleAssignmentsByGuildMessageUser as listActiveReactionRoleAssignmentsByGuildMessageUserPostgres,
    listActiveReactionRoleAssignmentsByGuildUser as listActiveReactionRoleAssignmentsByGuildUserPostgres,
    listReactionRoleMessagesByGuildId as listReactionRoleMessagesByGuildIdPostgres,
    markReactionRoleAssignmentRemoved as markReactionRoleAssignmentRemovedPostgres,
    markReactionRoleAssignmentsRemovedByMessageUser as markReactionRoleAssignmentsRemovedByMessageUserPostgres,
    reactionRoleMessageModes,
    reactionRoleMessageSources,
    upsertReactionRoleAssignment as upsertReactionRoleAssignmentPostgres,
    upsertReactionRoleMessage as upsertReactionRoleMessagePostgres,
    upsertReactionRoleOption as upsertReactionRoleOptionPostgres,
    upsertReactionRoleOptionByMessage as upsertReactionRoleOptionByMessagePostgres,
...
type PostgresReactionRolesDb = Parameters<typeof upsertReactionRoleMessagePostgres>[0];
type ReactionRolesDb = ConvexPersistenceDatabase | PostgresReactionRolesDb;
...
export async function upsertReactionRoleMessage(
    ...
    if (!isConvexPersistenceDatabase(db)) return upsertReactionRoleMessagePostgres(db, input);
...
export async function upsertReactionRoleOption(
    ...
    if (!isConvexPersistenceDatabase(db)) return upsertReactionRoleOptionPostgres(db, input);
...
export async function upsertReactionRoleOptionByMessage(
    ...
    if (!isConvexPersistenceDatabase(db)) return upsertReactionRoleOptionByMessagePostgres(db, input);
...
export async function listReactionRoleMessagesByGuildId(
    ...
    if (!isConvexPersistenceDatabase(db)) return listReactionRoleMessagesByGuildIdPostgres(db, input);
...
export async function findReactionRoleMessage(
    ...
    if (!isConvexPersistenceDatabase(db)) return findReactionRoleMessagePostgres(db, input);
...
export async function findEnabledReactionRoleOptionByReaction(
    ...
    if (!isConvexPersistenceDatabase(db)) return findEnabledReactionRoleOptionByReactionPostgres(db, input);
...
export async function deleteReactionRoleMessage(
    ...
    if (!isConvexPersistenceDatabase(db)) return deleteReactionRoleMessagePostgres(db, input);
...
export async function upsertReactionRoleAssignment(
    ...
    if (!isConvexPersistenceDatabase(db)) return upsertReactionRoleAssignmentPostgres(db, input);
...
export async function markReactionRoleAssignmentRemoved(
    ...
    if (!isConvexPersistenceDatabase(db)) return markReactionRoleAssignmentRemovedPostgres(db, input);
...
export async function listActiveReactionRoleAssignmentsByGuildUser(
    ...
    if (!isConvexPersistenceDatabase(db)) return listActiveReactionRoleAssignmentsByGuildUserPostgres(db, input);
...
export async function listActiveReactionRoleAssignmentsByGuildMessageUser(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return listActiveReactionRoleAssignmentsByGuildMessageUserPostgres(db, input);
    }
...
export async function markReactionRoleAssignmentsRemovedByMessageUser(
    ...
    if (!isConvexPersistenceDatabase(db)) return markReactionRoleAssignmentsRemovedByMessageUserPostgres(db, input);
...
export async function deleteReactionRoleOptionByMessage(
    ...
    if (!isConvexPersistenceDatabase(db)) return deleteReactionRoleOptionByMessagePostgres(db, input);
...
export async function deleteReactionRoleOption(
    ...
    if (!isConvexPersistenceDatabase(db)) return deleteReactionRoleOptionPostgres(db, input);
...
export async function findReactionRoleOption(
    ...
    if (!isConvexPersistenceDatabase(db)) return findReactionRoleOptionPostgres(db, input);
