...
import {
    createSuggestion as createSuggestionPostgres,
    createSuggestionBoard as createSuggestionBoardPostgres,
    deleteSuggestionBoard as deleteSuggestionBoardPostgres,
    deleteSuggestionVote as deleteSuggestionVotePostgres,
    findDefaultSuggestionBoardByGuildId as findDefaultSuggestionBoardByGuildIdPostgres,
    findSuggestionByGuildMessageId as findSuggestionByGuildMessageIdPostgres,
    findSuggestionVote as findSuggestionVotePostgres,
    listSuggestionBoardsByGuildId as listSuggestionBoardsByGuildIdPostgres,
    upsertSuggestionBoard as upsertSuggestionBoardPostgres,
    upsertSuggestionVote as upsertSuggestionVotePostgres,
    type GuildFeatureRepositoryError,
    type SuggestionBoardRecord,
    type SuggestionRecord,
    type SuggestionsRepositoryError,
...
type PostgresSuggestionsDb = Parameters<typeof upsertSuggestionBoardPostgres>[0];
type SuggestionsDb = ConvexPersistenceDatabase | PostgresSuggestionsDb;
...
export async function createSuggestionBoard(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return createSuggestionBoardPostgres(db, input);
    }
...
export async function upsertSuggestionBoard(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return upsertSuggestionBoardPostgres(db, input);
    }
...
export async function listSuggestionBoardsByGuildId(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return listSuggestionBoardsByGuildIdPostgres(db, input);
    }
...
export async function findDefaultSuggestionBoardByGuildId(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return findDefaultSuggestionBoardByGuildIdPostgres(db, input);
    }
...
export async function deleteSuggestionBoard(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return deleteSuggestionBoardPostgres(db, input);
    }
...
export async function createSuggestion(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return createSuggestionPostgres(db, input);
    }
...
export async function findSuggestionByGuildMessageId(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return findSuggestionByGuildMessageIdPostgres(db, input);
    }
...
export async function upsertSuggestionVote(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return upsertSuggestionVotePostgres(db, input);
    }
...
export async function deleteSuggestionVote(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return deleteSuggestionVotePostgres(db, input);
    }
...
export async function findSuggestionVote(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return findSuggestionVotePostgres(db, input);
    }
