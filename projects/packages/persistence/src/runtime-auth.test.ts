...
describe('Convex auth-store persistence wrappers', () => {
    ...
    it('maps web session nulls and validation failures like the Postgres repository', async () => {
        const db = createConvexDb({
    ...
    it('maps OAuth token nulls and validation failures like the Postgres repository', async () => {
        const db = createConvexDb({
