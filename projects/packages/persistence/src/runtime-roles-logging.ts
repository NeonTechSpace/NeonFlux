...
import {
    deleteAutoroleRule as deleteAutoroleRulePostgres,
    deleteGuildLoggingDestination as deleteGuildLoggingDestinationPostgres,
    findGuildLoggingDestinationByEventGroup as findGuildLoggingDestinationByEventGroupPostgres,
    listAutoroleRulesByGuildId as listAutoroleRulesByGuildIdPostgres,
    listEnabledAutoroleRulesByGuildId as listEnabledAutoroleRulesByGuildIdPostgres,
    listGuildLoggingDestinationsByGuildId as listGuildLoggingDestinationsByGuildIdPostgres,
    upsertAutoroleRule as upsertAutoroleRulePostgres,
    upsertGuildLoggingDestination as upsertGuildLoggingDestinationPostgres,
    type AutoroleRepositoryError,
    type AutoroleRuleRecord,
    type GuildFeatureRepositoryError,
    type GuildLoggingDestinationRecord,
    type GuildLoggingDestinationRepositoryError,
} from '@neonflux/db';
...
type PostgresAutoroleDb = Parameters<typeof upsertAutoroleRulePostgres>[0];
type PostgresLoggingDestinationDb = Parameters<typeof upsertGuildLoggingDestinationPostgres>[0];

type AutoroleDb = ConvexPersistenceDatabase | PostgresAutoroleDb;
type LoggingDestinationDb = ConvexPersistenceDatabase | PostgresLoggingDestinationDb;
...
export async function upsertAutoroleRule(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return upsertAutoroleRulePostgres(db, input);
    }
...
export async function listAutoroleRulesByGuildId(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return listAutoroleRulesByGuildIdPostgres(db, input);
    }
...
export async function listEnabledAutoroleRulesByGuildId(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return listEnabledAutoroleRulesByGuildIdPostgres(db, input);
    }
...
export async function deleteAutoroleRule(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return deleteAutoroleRulePostgres(db, input);
    }
...
export async function listGuildLoggingDestinationsByGuildId(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return listGuildLoggingDestinationsByGuildIdPostgres(db, input);
    }
...
export async function findGuildLoggingDestinationByEventGroup(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return findGuildLoggingDestinationByEventGroupPostgres(db, input);
    }
...
export async function upsertGuildLoggingDestination(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return upsertGuildLoggingDestinationPostgres(db, input);
    }
...
export async function deleteGuildLoggingDestination(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return deleteGuildLoggingDestinationPostgres(db, input);
    }
