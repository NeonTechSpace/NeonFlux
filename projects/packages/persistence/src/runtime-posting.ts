...
import {
    deleteMessageTemplate as deleteMessageTemplatePostgres,
    findMessageTemplateByName as findMessageTemplateByNamePostgres,
    listMessageTemplatesByGuildId as listMessageTemplatesByGuildIdPostgres,
    recordPostedMessage as recordPostedMessagePostgres,
    upsertMessageTemplate as upsertMessageTemplatePostgres,
    type GuildFeatureRepositoryError,
    type MessageTemplateRecord,
    type PostedMessageRecord,
    type PostingRepositoryError,
} from '@neonflux/db';
...
type PostgresPostingDb = Parameters<typeof upsertMessageTemplatePostgres>[0];
type PostingDb = ConvexPersistenceDatabase | PostgresPostingDb;
...
export async function upsertMessageTemplate(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return upsertMessageTemplatePostgres(db, input);
    }
...
export async function recordPostedMessage(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return recordPostedMessagePostgres(db, input);
    }
...
export async function listMessageTemplatesByGuildId(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return listMessageTemplatesByGuildIdPostgres(db, input);
    }
...
export async function findMessageTemplateByName(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return findMessageTemplateByNamePostgres(db, input);
    }
...
export async function deleteMessageTemplate(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return deleteMessageTemplatePostgres(db, input);
    }
