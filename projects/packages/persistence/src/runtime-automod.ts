...
import {
    automodActionTypes,
    automodTriggerTypes,
    deleteAutomodRule as deleteAutomodRulePostgres,
    listAutomodEventsByGuildId as listAutomodEventsByGuildIdPostgres,
    listAutomodRulesByGuildId as listAutomodRulesByGuildIdPostgres,
    listEnabledAutomodRulesByGuildId as listEnabledAutomodRulesByGuildIdPostgres,
    recordAutomodEvent as recordAutomodEventPostgres,
    saveAutomodRule as saveAutomodRulePostgres,
    updateAutomodEventStatus as updateAutomodEventStatusPostgres,
...
type PostgresAutomodDb = Parameters<typeof saveAutomodRulePostgres>[0];
type AutomodDb = ConvexPersistenceDatabase | PostgresAutomodDb;
...
export async function listAutomodRulesByGuildId(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return listAutomodRulesByGuildIdPostgres(db, input);
    }
...
export async function listEnabledAutomodRulesByGuildId(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return listEnabledAutomodRulesByGuildIdPostgres(db, input);
    }
...
export async function saveAutomodRule(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return saveAutomodRulePostgres(db, input);
    }
...
export async function deleteAutomodRule(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return deleteAutomodRulePostgres(db, input);
    }
...
export async function recordAutomodEvent(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return recordAutomodEventPostgres(db, input);
    }
...
export async function updateAutomodEventStatus(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return updateAutomodEventStatusPostgres(db, input);
    }
...
export async function listAutomodEventsByGuildId(
    ...
    if (!isConvexPersistenceDatabase(db)) {
        return listAutomodEventsByGuildIdPostgres(db, input);
    }
