import type { FluxerGuildChannel, FluxerGuildRole } from './guild-structure.js';
...
export function mapRequestedChannel(
    ...
    options: {
        ...
        currentChannel?: FluxerGuildChannel;
...
export function findUnmappedProtectedRoleIds(
    ...
    isProtected: (role: FluxerGuildRole, guildId: string | undefined) => boolean
): ReadonlySet<string> {
