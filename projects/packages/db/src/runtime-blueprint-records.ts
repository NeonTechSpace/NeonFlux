...
export function toBlueprintPlanStepPageRecord(record: ConvexBlueprintPlanStepPageRecord): BlueprintPlanStepPageRecord {
    return {
        steps: record.steps.map(toBlueprintPlanStepRecord),
        nextCursor: record.nextCursor,
    };
}
